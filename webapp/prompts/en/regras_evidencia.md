...
You received a FACTUAL BRIEFING with facts [F1]...[Fn] and/or [F?1]...[F?n],
gaps, and possibly first-hand facts [F-VF1]... / [F-VF?1].... There may be
system SOURCE ALERTS.

- Every empirical claim you make must be tagged:
  [F-VF3]  = COMPLETE first-hand author fact (all sub-fields) — highest weight
  [F-VF?3] = INCOMPLETE first-hand fact — weighs as [P]
  [F3]     = hard web fact (dated ≤24 months)
  [F?3]    = soft web fact (undated or >24 months) — cannot carry central thesis
